...
const CLR_ABU       = '6B7280';
const CLR_ABU_TUA   = 'E5E7EB';
const CLR_ABU_MUDA  = 'F3F4F6';
...
applyStyle($sheet, 'A1:I1', [
    ...
    'fill'      => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU]],
    'alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER, 'vertical' => Alignment::VERTICAL_CENTER],
    'borders'   => ['bottom' => ['borderStyle' => Border::BORDER_MEDIUM, 'color' => ['rgb' => CLR_ABU_TUA]]],
]);
...
applyStyle($sheet, 'A2:I2', [
    ...
    'fill'      => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU_MUDA]],
    'alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER, 'vertical' => Alignment::VERTICAL_CENTER],
]);
...
applyStyle($sheet, 'A4', array_merge(['font' => ['bold' => true, 'size' => 10, 'name' => 'Calibri'], 'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU_MUDA]], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_LEFT, 'vertical' => Alignment::VERTICAL_CENTER]], borderAll('CCCCCC')));
applyStyle($sheet, 'B4', array_merge(['font' => ['bold' => true, 'size' => 12, 'color' => ['rgb' => '000000'], 'name' => 'Calibri'], 'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => 'FFFFFF']], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER, 'vertical' => Alignment::VERTICAL_CENTER]], borderAll('CCCCCC')));

// Disetujui
$sheet->setCellValue('D4', 'Disetujui');
$sheet->setCellValue('E4', $disetujui);
applyStyle($sheet, 'D4', array_merge(['font' => ['bold' => true, 'size' => 10, 'name' => 'Calibri'], 'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU_MUDA]], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_LEFT, 'vertical' => Alignment::VERTICAL_CENTER]], borderAll('CCCCCC')));
...
applyStyle($sheet, 'G4', array_merge(['font' => ['bold' => true, 'size' => 10, 'name' => 'Calibri'], 'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU_MUDA]], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_LEFT, 'vertical' => Alignment::VERTICAL_CENTER]], borderAll('CCCCCC')));
...
applyStyle($sheet, 'D5', array_merge(['font' => ['bold' => true, 'size' => 10, 'name' => 'Calibri'], 'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU_MUDA]], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_LEFT, 'vertical' => Alignment::VERTICAL_CENTER]], borderAll('CCCCCC')));
...
applyStyle($sheet, 'G5', array_merge(['font' => ['bold' => true, 'size' => 10, 'name' => 'Calibri'], 'fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => CLR_ABU_MUDA]], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_LEFT, 'vertical' => Alignment::VERTICAL_CENTER]], borderAll('CCCCCC')));
...
foreach ($headers as $i => $header) {
    ...
    applyStyle($sheet, $cell, [
        ...
        'borders'   => ['allBorders' => ['borderStyle' => Border::BORDER_THIN, 'color' => ['rgb' => CLR_ABU_TUA]]],
    ]);
}
...
if (empty($data)) {
    ...
    foreach ($data as $row) {
        $isAlt = ($no % 2 === 0);
        $bgNormal = $isAlt ? CLR_ABU_MUDA : 'FFFFFF';
...
applyStyle($sheet, "A1:I{$lastDataRow}", [
    'borders' => [
        'allBorders' => [
            'borderStyle' => Border::BORDER_THIN,
            'color'       => ['rgb' => '000000'],
